...
summary: 'Despite not being at the end of my life, I may very well be nearing the end of my time with my parents.'
image: '/static/images/last-time-this-young/corleone-family.jpg'
---

<Image
  alt={`Don Corleone`}
  src={`/static/images/last-time-this-young/corleone-family.jpg`}
  width={528}
  height={587}
  priority
/>
