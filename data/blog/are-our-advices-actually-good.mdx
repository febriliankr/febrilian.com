...
summary: 'Sometimes I give advice to people, but were these really good advices? Or is it just my brain tricking me into thinking that I got everything figured out?'
image: '/static/images/are-our-advices-actually-good/red-giving-bad-advice.jpg'
---

<Image
  alt={`Red Giving Bad Advice`}
  src={`/static/images/are-our-advices-actually-good/red-giving-bad-advice.jpg`}
  width={1920}
  height={1080}
  priority
/>
...
<Image
  alt={`Taxi Driver Receiving Bad Advice`}
  src={`/static/images/are-our-advices-actually-good/taxi-driver-receiving-bad-advice.jpg`}
  width={1920}
  height={1080}
/>
